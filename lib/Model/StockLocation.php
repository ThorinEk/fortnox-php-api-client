    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling StockLocation., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling StockLocation., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        ...
        if ((mb_strlen($name) > 25)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StockLocation., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling StockLocation., must be bigger than or equal to 0.');
        }
