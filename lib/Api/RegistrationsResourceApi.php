...
/**
    ...
    /**
     * Operation listRegistrationsResource
     *
     ...
     * @param  string[] $service_ids An array of service IDs.  Example: s1,s2,s3 (optional)
     * @param  string[] $cost_center_ids An array of cost center IDs.  Example: cc1,cc2,cc3 (optional)
     * @param  string[] $reg_codes An array of registration codes.  Example: TID,SEM,FPE (optional)
     * @param  string[] $user_ids An array of user IDs that time/absence registrations belong to.  Example: 1,2,3 (optional)
     * @param  bool $include_registrations_without_project If the time/absence registration without project is included, or not. (optional)
     * @param  bool $invoiced If a document is created with the time/absence registration, or not. (optional)
     * @param  bool $in_invoice_basis If the time/absence registration is locked on an invoice basis, or not. (optional)
     * @param  bool $internal_time If the time/absence registration is internal, which is registered on an internal customer, or not. (optional)
     * @param  bool $non_invoiceable If the time/absence registration has been moved to non-invoiceable, or not. (optional)
    ...
    {
        list($response) = $this->listRegistrationsResourceWithHttpInfo($from_date, $to_date, $customer_ids, $project_ids, $service_ids, $cost_center_ids, $reg_codes, $user_ids, $include_registrations_without_project, $invoiced, $in_invoice_basis, $internal_time, $non_invoiceable, $include_non_invoiceable_charge_hours, $contentType);
        return $response;
    }

    /**
     * Operation listRegistrationsResourceWithHttpInfo
     *
     * Get time/absence registrations that match filter
     *
     * @param  \DateTime $from_date The start date of the search span, the max of which should be 1 year to the end date (\&quot;toDate\&quot;).  Example: 2022-11-01 (optional)
    ...
    /**
     * Operation listRegistrationsResourceAsync
     *
     * Get time/absence registrations that match filter
     *
     * @param  \DateTime $from_date The start date of the search span, the max of which should be 1 year to the end date (\&quot;toDate\&quot;).  Example: 2022-11-01 (optional)
     ...
     */
    public function listRegistrationsResourceAsync($from_date = null, $to_date = null, $customer_ids = null, $project_ids = null, $service_ids = null, $cost_center_ids = null, $reg_codes = null, $user_ids = null, $include_registrations_without_project = null, $invoiced = null, $in_invoice_basis = null, $internal_time = null, $non_invoiceable = null, $include_non_invoiceable_charge_hours = null, string $contentType = self::contentTypes['listRegistrationsResource'][0])
    {
        return $this->listRegistrationsResourceAsyncWithHttpInfo($from_date, $to_date, $customer_ids, $project_ids, $service_ids, $cost_center_ids, $reg_codes, $user_ids, $include_registrations_without_project, $invoiced, $in_invoice_basis, $internal_time, $non_invoiceable, $include_non_invoiceable_charge_hours, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listRegistrationsResourceAsyncWithHttpInfo
     *
     * Get time/absence registrations that match filter
     *
     * @param  \DateTime $from_date The start date of the search span, the max of which should be 1 year to the end date (\&quot;toDate\&quot;).  Example: 2022-11-01 (optional)
    ...
    /**
     * Create request for operation 'listRegistrationsResource'
     *
     * @param  \DateTime $from_date The start date of the search span, the max of which should be 1 year to the end date (\&quot;toDate\&quot;).  Example: 2022-11-01 (optional)
     * @param  \DateTime $to_date The end date of the search span, the max of which should be 1 year back to the start date (\&quot;fromDate\&quot;).  Example: 2022-11-30 (optional)
     * @param  string[] $customer_ids An array of customer IDs which are being used in database and in one-to-one relation with customer numbers.  Example: 100,101,102 (optional)
     ...
     */
    public function listRegistrationsResourceRequest($from_date = null, $to_date = null, $customer_ids = null, $project_ids = null, $service_ids = null, $cost_center_ids = null, $reg_codes = null, $user_ids = null, $include_registrations_without_project = null, $invoiced = null, $in_invoice_basis = null, $internal_time = null, $non_invoiceable = null, $include_non_invoiceable_charge_hours = null, string $contentType = self::contentTypes['listRegistrationsResource'][0])
    {
        ...
        $resourcePath = '/api/time/registrations-v2';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $include_non_invoiceable_charge_hours,
            'includeNonInvoiceableChargeHours', // param base name
            'boolean', // openApiType
            '', // style
            false, // explode
            false // required
