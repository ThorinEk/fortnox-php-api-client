 ...
 * @link     https://openapi-generator.tech
 */
class VacationDebtBasisResourceApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation getVacationDebtBasisResource
     *
    ...
    {
        list($response) = $this->getVacationDebtBasisResourceWithHttpInfo($year, $month, $contentType);
        return $response;
    }

    /**
     * Operation getVacationDebtBasisResourceWithHttpInfo
     *
     * Retrieve a specific vacation debt basis for a posted voucher
     *
    ...
    /**
     * Operation getVacationDebtBasisResourceAsync
     *
     * Retrieve a specific vacation debt basis for a posted voucher
     *
     * @param  int $year (required)
     ...
     */
    public function getVacationDebtBasisResourceAsync($year, $month, string $contentType = self::contentTypes['getVacationDebtBasisResource'][0])
    {
        return $this->getVacationDebtBasisResourceAsyncWithHttpInfo($year, $month, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getVacationDebtBasisResourceAsyncWithHttpInfo
     *
     * Retrieve a specific vacation debt basis for a posted voucher
     *
     * @param  int $year (required)
    ...
    /**
     * Create request for operation 'getVacationDebtBasisResource'
     *
     * @param  int $year (required)
     * @param  int $month (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getVacationDebtBasisResource'] to see the possible values for this operation
     ...
     */
    public function getVacationDebtBasisResourceRequest($year, $month, string $contentType = self::contentTypes['getVacationDebtBasisResource'][0])
    {

        // verify the required parameter 'year' is set
        if ($year === null || (is_array($year) && count($year) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $year when calling getVacationDebtBasisResource'
            );
        }
        ...
        if ($month === null || (is_array($month) && count($month) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $month when calling getVacationDebtBasisResource'
            );
        }


        $resourcePath = '/3/vacationdebtbasis/{Year}/{Month}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
