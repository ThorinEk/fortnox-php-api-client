 ...
 */
class VoucherSeriesListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VoucherSeriesListItem';
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $code when calling VoucherSeriesListItem., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling VoucherSeriesListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VoucherSeriesListItem., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling VoucherSeriesListItem., must be bigger than or equal to 0.');
        }
