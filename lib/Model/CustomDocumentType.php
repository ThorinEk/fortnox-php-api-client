...
/**
 * CustomDocumentType Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class CustomDocumentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomDocumentType';
    ...
    public const CATEGORY_OUTBOUND = 'OUTBOUND';
    ...
    {
        return [
            self::CATEGORY_INBOUND,
            self::CATEGORY_OUTBOUND,
        ];
    }
    ...
    */
    ...
    public function setReferenceType($reference_type)
    {
        ...
        if ((mb_strlen($reference_type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $reference_type when calling CustomDocumentType., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($reference_type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $reference_type when calling CustomDocumentType., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9_-]+/", $reference_type))) {
            throw new \InvalidArgumentException("invalid value for \$reference_type when calling CustomDocumentType., must conform to the pattern /[a-zA-Z0-9_-]+/.");
        }
