 ...
 */
class CustomInboundDocument implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CustomInboundDocument';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['type']) && !preg_match("/[a-zA-Z0-9_-]+/", $this->container['type'])) {
            $invalidProperties[] = "invalid value for 'type', must be conform to the pattern /[a-zA-Z0-9_-]+/.";
        }
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 25)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomInboundDocument., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $id when calling CustomInboundDocument., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/^[0-9]+/", $id))) {
            throw new \InvalidArgumentException("invalid value for \$id when calling CustomInboundDocument., must conform to the pattern /^[0-9]+/.");
        }
    ...
    public function setType($type)
    {
        ...
        if ((mb_strlen($type) > 25)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CustomInboundDocument., must be smaller than or equal to 25.');
        }
        if ((mb_strlen($type) < 1)) {
            throw new \InvalidArgumentException('invalid length for $type when calling CustomInboundDocument., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[a-zA-Z0-9_-]+/", $type))) {
            throw new \InvalidArgumentException("invalid value for \$type when calling CustomInboundDocument., must conform to the pattern /[a-zA-Z0-9_-]+/.");
        }
    ...
    public function setNote($note)
    {
        ...
        if ((mb_strlen($note) > 1000)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CustomInboundDocument., must be smaller than or equal to 1000.');
        }
        if ((mb_strlen($note) < 0)) {
            throw new \InvalidArgumentException('invalid length for $note when calling CustomInboundDocument., must be bigger than or equal to 0.');
        }
