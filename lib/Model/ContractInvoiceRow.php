...
/**
 * ContractInvoiceRow Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ContractInvoiceRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Contract_InvoiceRow';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['delivered_quantity'] === null) {
            $invalidProperties[] = "'delivered_quantity' can't be null";
        }
    ...
    public function setAccountNumber($account_number)
    {
        ...
        if (($account_number > 9999)) {
            throw new \InvalidArgumentException('invalid value for $account_number when calling ContractInvoiceRow., must be smaller than or equal to 9999.');
        }
        if (($account_number < 1000)) {
            throw new \InvalidArgumentException('invalid value for $account_number when calling ContractInvoiceRow., must be bigger than or equal to 1000.');
        }
     ...
     *
     * @param string $delivered_quantity delivered_quantity
     *
     * @return self
     */
