 ...
 * @link     https://openapi-generator.tech
 */
class CompanyInformationResourceApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation getCompanyInformationResource
     *
    ...
    {
        list($response) = $this->getCompanyInformationResourceWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getCompanyInformationResourceWithHttpInfo
     *
     * Retrieve the Company Information
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCompanyInformationResource'] to see the possible values for this operation
    ...
    /**
     * Operation getCompanyInformationResourceAsync
     *
     * Retrieve the Company Information
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCompanyInformationResource'] to see the possible values for this operation
     ...
     */
    public function getCompanyInformationResourceAsync(string $contentType = self::contentTypes['getCompanyInformationResource'][0])
    {
        return $this->getCompanyInformationResourceAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getCompanyInformationResourceAsyncWithHttpInfo
     *
     * Retrieve the Company Information
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCompanyInformationResource'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'getCompanyInformationResource'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getCompanyInformationResource'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function getCompanyInformationResourceRequest(string $contentType = self::contentTypes['getCompanyInformationResource'][0])
    {


        $resourcePath = '/3/companyinformation';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
