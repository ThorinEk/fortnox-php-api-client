...
/**
    ...
    /**
     * Operation createExpensesResource
     *
     * Create an expense
     *
    ...
    {
        list($response) = $this->createExpensesResourceWithHttpInfo($expense, $contentType);
        return $response;
    }

    /**
     * Operation createExpensesResourceWithHttpInfo
     *
     * Create an expense
     *
     * @param  \FortnoxApi\Model\ExpenseWrap $expense expense to create (optional)
    ...
    /**
     * Operation createExpensesResourceAsync
     *
     * Create an expense
     *
     * @param  \FortnoxApi\Model\ExpenseWrap $expense expense to create (optional)
     ...
     */
    public function createExpensesResourceAsync($expense = null, string $contentType = self::contentTypes['createExpensesResource'][0])
    {
        return $this->createExpensesResourceAsyncWithHttpInfo($expense, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createExpensesResourceAsyncWithHttpInfo
     *
     * Create an expense
     *
     * @param  \FortnoxApi\Model\ExpenseWrap $expense expense to create (optional)
     ...
     */
    public function createExpensesResourceRequest($expense = null, string $contentType = self::contentTypes['createExpensesResource'][0])
    {



        $resourcePath = '/3/expenses/';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if (isset($expense)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($expense));
            } else {
                $httpBody = $expense;
            }
    ...
    {
        list($response) = $this->getExpensesResourceWithHttpInfo($expense_code, $contentType);
        return $response;
    }

    /**
     * Operation getExpensesResourceWithHttpInfo
     *
     * Retrieve an expense
     *
     * @param  string $expense_code expenseCode (required)
    ...
    /**
     * Operation getExpensesResourceAsync
     *
     * Retrieve an expense
     *
     * @param  string $expense_code expenseCode (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpensesResourceAsync($expense_code, string $contentType = self::contentTypes['getExpensesResource'][0])
    {
        return $this->getExpensesResourceAsyncWithHttpInfo($expense_code, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExpensesResourceAsyncWithHttpInfo
     *
     * Retrieve an expense
     *
     * @param  string $expense_code expenseCode (required)
    ...
    /**
     * Create request for operation 'getExpensesResource'
     *
     * @param  string $expense_code expenseCode (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getExpensesResource'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpensesResourceRequest($expense_code, string $contentType = self::contentTypes['getExpensesResource'][0])
    {

        // verify the required parameter 'expense_code' is set
        if ($expense_code === null || (is_array($expense_code) && count($expense_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $expense_code when calling getExpensesResource'
            );
        }


        $resourcePath = '/3/expenses/{ExpenseCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($expense_code !== null) {
            $resourcePath = str_replace(
                '{' . 'ExpenseCode' . '}',
                ObjectSerializer::toPathValue($expense_code),
                $resourcePath
            );
        }
    ...
    /**
     * Operation listExpensesResource
     *
     * Retrieve expenses
     *
    ...
    {
        list($response) = $this->listExpensesResourceWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation listExpensesResourceWithHttpInfo
     *
     * Retrieve expenses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listExpensesResource'] to see the possible values for this operation
    ...
    /**
     * Operation listExpensesResourceAsync
     *
     * Retrieve expenses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listExpensesResource'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listExpensesResourceAsync(string $contentType = self::contentTypes['listExpensesResource'][0])
    {
        return $this->listExpensesResourceAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listExpensesResourceAsyncWithHttpInfo
     *
     * Retrieve expenses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listExpensesResource'] to see the possible values for this operation
    ...
    /**
     * Create request for operation 'listExpensesResource'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listExpensesResource'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listExpensesResourceRequest(string $contentType = self::contentTypes['listExpensesResource'][0])
    {
