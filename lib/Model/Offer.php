...
class Offer implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'your_reference_number' => 'setYourReferenceNumber',
        'zip_code' => 'setZipCode',
    ...
    protected static $getters = [
        ...
        'your_reference_number' => 'getYourReferenceNumber',
        'zip_code' => 'getZipCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('offer_rows', $data ?? [], null);
        ...
        $this->setIfExists('your_reference_number', $data ?? [], null);
    ...
    */
    ...
    public function setAddress1($address1)
    {
        ...
        if ((mb_strlen($address1) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setAddress2($address2)
    {
        ...
        if ((mb_strlen($address2) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setCity($city)
    {
        ...
        if ((mb_strlen($city) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $city when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setComments($comments)
    {
        ...
        if ((mb_strlen($comments) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($comments) < 0)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setDeliveryAddress1($delivery_address1)
    {
        ...
        if ((mb_strlen($delivery_address1) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address1 when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($delivery_address1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address1 when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setDeliveryAddress2($delivery_address2)
    {
        ...
        if ((mb_strlen($delivery_address2) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address2 when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($delivery_address2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $delivery_address2 when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setDeliveryCity($delivery_city)
    {
        ...
        if ((mb_strlen($delivery_city) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $delivery_city when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($delivery_city) < 0)) {
            throw new \InvalidArgumentException('invalid length for $delivery_city when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    public function setDeliveryName($delivery_name)
    {
        ...
        if ((mb_strlen($delivery_name) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $delivery_name when calling Offer., must be smaller than or equal to 1024.');
        }
        if ((mb_strlen($delivery_name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $delivery_name when calling Offer., must be bigger than or equal to 0.');
        }
    ...
    {
        return $this->container['offer_rows'];
    }
     ...
     * @return self
     */
    public function setOfferRows($offer_rows)
    {
        if (is_null($offer_rows)) {
            throw new \InvalidArgumentException('non-nullable offer_rows cannot be null');
        }
        $this->container['offer_rows'] = $offer_rows;
    ...
    /**
     * Gets your_reference_number
     *
     * @return string|null
     */
    public function getYourReferenceNumber()
    {
        return $this->container['your_reference_number'];
    }

    /**
     * Sets your_reference_number
     *
     * @param string|null $your_reference_number your_reference_number
     *
     * @return self
     */
    public function setYourReferenceNumber($your_reference_number)
    {
        if (is_null($your_reference_number)) {
            throw new \InvalidArgumentException('non-nullable your_reference_number cannot be null');
        }
        $this->container['your_reference_number'] = $your_reference_number;
