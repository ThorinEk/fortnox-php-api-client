...
/**
 * AbsenceTransactionSingleItem Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class AbsenceTransactionSingleItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AbsenceTransactionSingleItem';
    ...
    */
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AbsenceTransactionSingleItem., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($employee_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AbsenceTransactionSingleItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCauseCode($cause_code)
    {
        ...
        if ((mb_strlen($cause_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $cause_code when calling AbsenceTransactionSingleItem., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($cause_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cause_code when calling AbsenceTransactionSingleItem., must be bigger than or equal to 3.');
        }
