...
/**
    ...
    /**
     * Operation getStockBalance
     *
     * Get stock balance
     *
     * @param  string[] $item_ids A comma-separated list of itemIds. (optional)
    ...
    {
        list($response) = $this->getStockBalanceWithHttpInfo($item_ids, $stock_point_codes, $contentType);
        return $response;
    }

    /**
     * Operation getStockBalanceWithHttpInfo
     *
     * Get stock balance
     *
     * @param  string[] $item_ids A comma-separated list of itemIds. (optional)
    ...
    /**
     * Operation getStockBalanceAsync
     *
     * Get stock balance
     *
     * @param  string[] $item_ids A comma-separated list of itemIds. (optional)
     ...
     */
    public function getStockBalanceAsync($item_ids = null, $stock_point_codes = null, string $contentType = self::contentTypes['getStockBalance'][0])
    {
        return $this->getStockBalanceAsyncWithHttpInfo($item_ids, $stock_point_codes, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStockBalanceAsyncWithHttpInfo
     *
     * Get stock balance
     *
     * @param  string[] $item_ids A comma-separated list of itemIds. (optional)
    ...
    /**
     * Create request for operation 'getStockBalance'
     *
     * @param  string[] $item_ids A comma-separated list of itemIds. (optional)
     * @param  string[] $stock_point_codes Optional filter on stock point codes (comma-separated). (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getStockBalance'] to see the possible values for this operation
     ...
     */
    public function getStockBalanceRequest($item_ids = null, $stock_point_codes = null, string $contentType = self::contentTypes['getStockBalance'][0])
    {




        $resourcePath = '/api/warehouse/status-v1/stockbalance';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $stock_point_codes,
            'stockPointCodes', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
