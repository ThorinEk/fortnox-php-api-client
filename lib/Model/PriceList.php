...
class PriceList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pre_selected', $data ?? [], null);
    }
    ...
    */
    ...
    public function setCode($code)
    {
        ...
        if ((mb_strlen($code) > 100)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PriceList., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling PriceList., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 50)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PriceList., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling PriceList., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['pre_selected'];
    }

    /**
     * Sets pre_selected
     *
     * @param bool|null $pre_selected pre_selected
     *
     * @return self
     */
    public function setPreSelected($pre_selected)
    {
        if (is_null($pre_selected)) {
            throw new \InvalidArgumentException('non-nullable pre_selected cannot be null');
        }
        $this->container['pre_selected'] = $pre_selected;
