    ...
    */
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling Employee., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($employee_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling Employee., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxColumn($tax_column)
    {
        ...
        if (($tax_column > 6)) {
            throw new \InvalidArgumentException('invalid value for $tax_column when calling Employee., must be smaller than or equal to 6.');
        }
        if (($tax_column < 1)) {
            throw new \InvalidArgumentException('invalid value for $tax_column when calling Employee., must be bigger than or equal to 1.');
        }
