<?php
/**
 * AttendanceTransactionsResourceApi
 * PHP version 7.4
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class AttendanceTransactionsResourceApi
{
    /**
     * @var ClientInterface
     */
...
/**
    ...
    /**
     * Operation createAttendanceTransactionsResource
     *
    ...
    {
        list($response) = $this->createAttendanceTransactionsResourceWithHttpInfo($attendance_transaction, $contentType);
        return $response;
    }

    /**
     * Operation createAttendanceTransactionsResourceWithHttpInfo
     *
     * Create a new attendance transaction
     *
     * @param  \OpenAPI\Client\Model\AttendanceTransactionWrap $attendance_transaction attendance transaction to create (optional)
    ...
    /**
     * Operation createAttendanceTransactionsResourceAsync
     *
     * Create a new attendance transaction
     *
     * @param  \OpenAPI\Client\Model\AttendanceTransactionWrap $attendance_transaction attendance transaction to create (optional)
     ...
     */
    public function createAttendanceTransactionsResourceAsync($attendance_transaction = null, string $contentType = self::contentTypes['createAttendanceTransactionsResource'][0])
    {
        return $this->createAttendanceTransactionsResourceAsyncWithHttpInfo($attendance_transaction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createAttendanceTransactionsResourceAsyncWithHttpInfo
     *
     * Create a new attendance transaction
     *
     * @param  \OpenAPI\Client\Model\AttendanceTransactionWrap $attendance_transaction attendance transaction to create (optional)
     ...
     */
    public function createAttendanceTransactionsResourceRequest($attendance_transaction = null, string $contentType = self::contentTypes['createAttendanceTransactionsResource'][0])
    {



        $resourcePath = '/3/attendancetransactions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($attendance_transaction)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($attendance_transaction));
            } else {
                $httpBody = $attendance_transaction;
            }
    ...
    /**
     * Operation getAttendanceTransactionsResource
     *
    ...
    {
        list($response) = $this->getAttendanceTransactionsResourceWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getAttendanceTransactionsResourceWithHttpInfo
     *
     * Retrieve a specific attendance transaction
     *
     * @param  string $id identifies the transaction (required)
    ...
    /**
     * Operation getAttendanceTransactionsResourceAsync
     *
     * Retrieve a specific attendance transaction
     *
     * @param  string $id identifies the transaction (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttendanceTransactionsResourceAsync($id, string $contentType = self::contentTypes['getAttendanceTransactionsResource'][0])
    {
        return $this->getAttendanceTransactionsResourceAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAttendanceTransactionsResourceAsyncWithHttpInfo
     *
     * Retrieve a specific attendance transaction
     *
     * @param  string $id identifies the transaction (required)
    ...
    /**
     * Create request for operation 'getAttendanceTransactionsResource'
     *
     * @param  string $id identifies the transaction (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAttendanceTransactionsResource'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAttendanceTransactionsResourceRequest($id, string $contentType = self::contentTypes['getAttendanceTransactionsResource'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getAttendanceTransactionsResource'
            );
        }


        $resourcePath = '/3/attendancetransactions/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation listAttendanceTransactionsResource
     *
    ...
    {
        list($response) = $this->listAttendanceTransactionsResourceWithHttpInfo($employeeid, $date, $contentType);
        return $response;
    }

    /**
     * Operation listAttendanceTransactionsResourceWithHttpInfo
     *
     * Lists all attendance transactions
     *
     * @param  string $employeeid filter by employee id (optional)
    ...
    /**
     * Operation listAttendanceTransactionsResourceAsync
     *
     * Lists all attendance transactions
     *
     * @param  string $employeeid filter by employee id (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listAttendanceTransactionsResourceAsync($employeeid = null, $date = null, string $contentType = self::contentTypes['listAttendanceTransactionsResource'][0])
    {
        return $this->listAttendanceTransactionsResourceAsyncWithHttpInfo($employeeid, $date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listAttendanceTransactionsResourceAsyncWithHttpInfo
     *
     * Lists all attendance transactions
     *
     * @param  string $employeeid filter by employee id (optional)
    ...
    /**
     * Create request for operation 'listAttendanceTransactionsResource'
     *
     * @param  string $employeeid filter by employee id (optional)
     * @param  string $date filter by date (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['listAttendanceTransactionsResource'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listAttendanceTransactionsResourceRequest($employeeid = null, $date = null, string $contentType = self::contentTypes['listAttendanceTransactionsResource'][0])
    {
    ...
    /**
     * Operation updateAttendanceTransactionsResource
     *
    ...
    {
        list($response) = $this->updateAttendanceTransactionsResourceWithHttpInfo($id, $attendance_transaction, $contentType);
        return $response;
    }

    /**
     * Operation updateAttendanceTransactionsResourceWithHttpInfo
     *
     * Update a single attendance transaction
     *
     * @param  string $id identifies the transaction (required)
    ...
    /**
     * Operation updateAttendanceTransactionsResourceAsync
     *
     * Update a single attendance transaction
     *
     * @param  string $id identifies the transaction (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAttendanceTransactionsResourceAsync($id, $attendance_transaction = null, string $contentType = self::contentTypes['updateAttendanceTransactionsResource'][0])
    {
        return $this->updateAttendanceTransactionsResourceAsyncWithHttpInfo($id, $attendance_transaction, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateAttendanceTransactionsResourceAsyncWithHttpInfo
     *
     * Update a single attendance transaction
     *
     * @param  string $id identifies the transaction (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAttendanceTransactionsResourceRequest($id, $attendance_transaction = null, string $contentType = self::contentTypes['updateAttendanceTransactionsResource'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling updateAttendanceTransactionsResource'
            );
        }
