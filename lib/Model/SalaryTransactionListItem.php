...
/**
 * SalaryTransactionListItem Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class SalaryTransactionListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SalaryTransactionListItem';
    ...
    */
    ...
    public function setExpense($expense)
    {
        ...
        if ((mb_strlen($expense) > 6)) {
            throw new \InvalidArgumentException('invalid length for $expense when calling SalaryTransactionListItem., must be smaller than or equal to 6.');
        }
        if ((mb_strlen($expense) < 0)) {
            throw new \InvalidArgumentException('invalid length for $expense when calling SalaryTransactionListItem., must be bigger than or equal to 0.');
        }
    ...
    public function setTextRow($text_row)
    {
        ...
        if ((mb_strlen($text_row) > 40)) {
            throw new \InvalidArgumentException('invalid length for $text_row when calling SalaryTransactionListItem., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($text_row) < 0)) {
            throw new \InvalidArgumentException('invalid length for $text_row when calling SalaryTransactionListItem., must be bigger than or equal to 0.');
        }
