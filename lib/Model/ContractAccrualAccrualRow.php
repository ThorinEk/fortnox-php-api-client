...
/**
 * ContractAccrualAccrualRow Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class ContractAccrualAccrualRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ContractAccrual_AccrualRow';
    ...
    */
    ...
    public function setTransactionInformation($transaction_information)
    {
        ...
        if ((mb_strlen($transaction_information) > 100)) {
            throw new \InvalidArgumentException('invalid length for $transaction_information when calling ContractAccrualAccrualRow., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($transaction_information) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transaction_information when calling ContractAccrualAccrualRow., must be bigger than or equal to 0.');
        }
