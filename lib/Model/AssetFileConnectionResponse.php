 ...
 */
class AssetFileConnectionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AssetFileConnectionResponse';
    ...
    protected static $attributeMap = [
        'asset_file_connections' => 'AssetFileConnections',
    ...
    protected static $setters = [
        'asset_file_connections' => 'setAssetFileConnections',
    ...
    protected static $getters = [
        'asset_file_connections' => 'getAssetFileConnections',
    ...
    {
        $this->setIfExists('asset_file_connections', $data ?? [], null);
        $this->setIfExists('meta_information', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['asset_file_connections'];
    }
     ...
     * @return self
     */
    public function setAssetFileConnections($asset_file_connections)
    {
        if (is_null($asset_file_connections)) {
            throw new \InvalidArgumentException('non-nullable asset_file_connections cannot be null');
        }
        $this->container['asset_file_connections'] = $asset_file_connections;
    ...
    public function setMetaInformation($meta_information)
    {
        if (is_null($meta_information)) {
            throw new \InvalidArgumentException('non-nullable meta_information cannot be null');
        }
