 ...
 */
class SupplierInvoiceAccrual implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplierInvoiceAccrual';
    ...
    protected static $openAPIFormats = [
        ...
        'total' => 'double',
        'vat_included' => null,
        'supplier_invoice_accrual_rows' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'total' => false,
		'vat_included' => false,
		'supplier_invoice_accrual_rows' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'supplier_invoice_accrual_rows' => 'SupplierInvoiceAccrualRows'
    ];
    ...
    protected static $setters = [
        ...
        'supplier_invoice_accrual_rows' => 'setSupplierInvoiceAccrualRows'
    ];
    ...
    protected static $getters = [
        ...
        'supplier_invoice_accrual_rows' => 'getSupplierInvoiceAccrualRows'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('supplier_invoice_accrual_rows', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['supplier_invoice_number'] === null) {
            $invalidProperties[] = "'supplier_invoice_number' can't be null";
        }
        ...
        if ($this->container['supplier_invoice_accrual_rows'] === null) {
            $invalidProperties[] = "'supplier_invoice_accrual_rows' can't be null";
        }
        if ((count($this->container['supplier_invoice_accrual_rows']) > 2147483647)) {
            $invalidProperties[] = "invalid value for 'supplier_invoice_accrual_rows', number of items must be less than or equal to 2147483647.";
        }

        if ((count($this->container['supplier_invoice_accrual_rows']) < 2)) {
            $invalidProperties[] = "invalid value for 'supplier_invoice_accrual_rows', number of items must be greater than or equal to 2.";
        }
    ...
    public function setAccrualAccount($accrual_account)
    {
        ...
        if (($accrual_account > 9999)) {
            throw new \InvalidArgumentException('invalid value for $accrual_account when calling SupplierInvoiceAccrual., must be smaller than or equal to 9999.');
        }
        if (($accrual_account < 1000)) {
            throw new \InvalidArgumentException('invalid value for $accrual_account when calling SupplierInvoiceAccrual., must be bigger than or equal to 1000.');
        }
    ...
    public function setCostAccount($cost_account)
    {
        ...
        if (($cost_account > 9999)) {
            throw new \InvalidArgumentException('invalid value for $cost_account when calling SupplierInvoiceAccrual., must be smaller than or equal to 9999.');
        }
        if (($cost_account < 1000)) {
            throw new \InvalidArgumentException('invalid value for $cost_account when calling SupplierInvoiceAccrual., must be bigger than or equal to 1000.');
        }
     ...
     *
     * @param int $supplier_invoice_number supplier_invoice_number
     *
     * @return self
     */
    ...
    {
        return $this->container['supplier_invoice_accrual_rows'];
    }
     ...
     * @return self
     */
    public function setSupplierInvoiceAccrualRows($supplier_invoice_accrual_rows)
    {
        if (is_null($supplier_invoice_accrual_rows)) {
            throw new \InvalidArgumentException('non-nullable supplier_invoice_accrual_rows cannot be null');
        }

        if ((count($supplier_invoice_accrual_rows) > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $supplier_invoice_accrual_rows when calling SupplierInvoiceAccrual., number of items must be less than or equal to 2147483647.');
        }
        if ((count($supplier_invoice_accrual_rows) < 2)) {
            throw new \InvalidArgumentException('invalid length for $supplier_invoice_accrual_rows when calling SupplierInvoiceAccrual., number of items must be greater than or equal to 2.');
        }
        $this->container['supplier_invoice_accrual_rows'] = $supplier_invoice_accrual_rows;
