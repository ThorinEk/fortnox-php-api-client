 ...
 */
class TRItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TRItem';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('sales_prices', $data ?? [], null);
        $this->setIfExists('type', $data ?? [], null);
        $this->setIfExists('unit', $data ?? [], null);
        $this->setIfExists('is_stock', $data ?? [], null);
    }
    ...
    */
    ...
    public function setId($id)
    {
        ...
        if ((mb_strlen($id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TRItem., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($id) < 0)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TRItem., must be bigger than or equal to 0.');
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TRItem., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($description) < 0)) {
            throw new \InvalidArgumentException('invalid length for $description when calling TRItem., must be bigger than or equal to 0.');
        }
    ...
    {
        if (is_null($sales_prices)) {
            throw new \InvalidArgumentException('non-nullable sales_prices cannot be null');
        }
     ...
     * Sets is_stock
     *
     * @param bool|null $is_stock is_stock
     *
     * @return self
     */
    ...
    {
        if (is_null($is_stock)) {
            throw new \InvalidArgumentException('non-nullable is_stock cannot be null');
        }
