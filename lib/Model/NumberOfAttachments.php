...
/**
 * NumberOfAttachments Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class NumberOfAttachments implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumberOfAttachments';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('number_of_attachments', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $number_of_attachments number_of_attachments
     *
     * @return self
     */
    public function setNumberOfAttachments($number_of_attachments)
    {
        if (is_null($number_of_attachments)) {
            throw new \InvalidArgumentException('non-nullable number_of_attachments cannot be null');
        }
