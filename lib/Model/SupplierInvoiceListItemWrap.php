 ...
 */
class SupplierInvoiceListItemWrap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SupplierInvoiceListItem_Wrap';
