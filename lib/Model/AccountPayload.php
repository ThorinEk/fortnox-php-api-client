 ...
 */
class AccountPayload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountPayload';
    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AccountPayload., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AccountPayload., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (($number > 9999)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountPayload., must be smaller than or equal to 9999.');
        }
        if (($number < 1000)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountPayload., must be bigger than or equal to 1000.');
        }
