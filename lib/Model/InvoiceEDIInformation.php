...
/**
 * InvoiceEDIInformation Class Doc Comment
 *
 * @category Class
 * @package  FortnoxApi
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceEDIInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Invoice_EDIInformation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('edi_status', $data ?? [], null);
    }
    ...
    */
    ...
    public function setEdiGlobalLocationNumber($edi_global_location_number)
    {
        ...
        if ((mb_strlen($edi_global_location_number) > 13)) {
            throw new \InvalidArgumentException('invalid length for $edi_global_location_number when calling InvoiceEDIInformation., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($edi_global_location_number) < 0)) {
            throw new \InvalidArgumentException('invalid length for $edi_global_location_number when calling InvoiceEDIInformation., must be bigger than or equal to 0.');
        }
    ...
    public function setEdiGlobalLocationNumberDelivery($edi_global_location_number_delivery)
    {
        ...
        if ((mb_strlen($edi_global_location_number_delivery) > 13)) {
            throw new \InvalidArgumentException('invalid length for $edi_global_location_number_delivery when calling InvoiceEDIInformation., must be smaller than or equal to 13.');
        }
        if ((mb_strlen($edi_global_location_number_delivery) < 0)) {
            throw new \InvalidArgumentException('invalid length for $edi_global_location_number_delivery when calling InvoiceEDIInformation., must be bigger than or equal to 0.');
        }
     ...
     * Sets edi_status
     *
     * @param string|null $edi_status edi_status
     *
     * @return self
     */
    public function setEdiStatus($edi_status)
    {
        if (is_null($edi_status)) {
            throw new \InvalidArgumentException('non-nullable edi_status cannot be null');
        }
