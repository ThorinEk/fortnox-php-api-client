...
/**
     ...
     * Create a currency
     *
     * @param  \FortnoxApi\Model\CurrencyWrap $currency currency to create (optional)
     ...
     * @return \FortnoxApi\Model\CurrencyWrap
     */
     ...
     * @throws \FortnoxApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FortnoxApi\Model\CurrencyWrap, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCurrenciesResourceWithHttpInfo($currency = null, string $contentType = self::contentTypes['createCurrenciesResource'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FortnoxApi\Model\CurrencyWrap' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FortnoxApi\Model\CurrencyWrap' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FortnoxApi\Model\CurrencyWrap', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FortnoxApi\Model\CurrencyWrap';
     ...
     * @throws \FortnoxApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \FortnoxApi\Model\CurrencyList
     */
     ...
     * @throws \FortnoxApi\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \FortnoxApi\Model\CurrencyList, HTTP status code, HTTP response headers (array of strings)
     */
    public function listCurrenciesResourceWithHttpInfo(string $contentType = self::contentTypes['listCurrenciesResource'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\FortnoxApi\Model\CurrencyList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\FortnoxApi\Model\CurrencyList' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\FortnoxApi\Model\CurrencyList', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\FortnoxApi\Model\CurrencyList';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     *
     * @param  string $code identifies the currency (required)
     * @param  \FortnoxApi\Model\CurrencyWrap $currency to update (optional)
