 ...
 */
class TaxReductionWrap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TaxReduction_Wrap';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['tax_reduction'] === null) {
            $invalidProperties[] = "'tax_reduction' can't be null";
        }
