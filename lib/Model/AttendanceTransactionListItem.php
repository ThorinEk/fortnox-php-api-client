...
/**
 * AttendanceTransactionListItem Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AttendanceTransactionListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AttendanceTransactionListItem';
    ...
    public const CAUSE_CODE_ARB = 'ARB';
    public const CAUSE_CODE_BE2 = 'BE2';
    public const CAUSE_CODE_BER = 'BER';
    public const CAUSE_CODE_FLX = 'FLX';
    public const CAUSE_CODE_HLG = 'HLG';
    public const CAUSE_CODE_JO2 = 'JO2';
    public const CAUSE_CODE_JOR = 'JOR';
    public const CAUSE_CODE_MER = 'MER';
    public const CAUSE_CODE_OB1 = 'OB1';
    public const CAUSE_CODE_OB2 = 'OB2';
    public const CAUSE_CODE_OB3 = 'OB3';
    public const CAUSE_CODE_OB4 = 'OB4';
    public const CAUSE_CODE_OB5 = 'OB5';
    public const CAUSE_CODE_OK0 = 'OK0';
    public const CAUSE_CODE_OK1 = 'OK1';
    public const CAUSE_CODE_OK2 = 'OK2';
    public const CAUSE_CODE_OK3 = 'OK3';
    public const CAUSE_CODE_OK4 = 'OK4';
    public const CAUSE_CODE_OK5 = 'OK5';
    public const CAUSE_CODE_OT1 = 'OT1';
    public const CAUSE_CODE_OT2 = 'OT2';
    public const CAUSE_CODE_OT3 = 'OT3';
    public const CAUSE_CODE_OT4 = 'OT4';
    public const CAUSE_CODE_OT5 = 'OT5';
    public const CAUSE_CODE_RES = 'RES';
    public const CAUSE_CODE_TID = 'TID';
    ...
    */
    ...
    public function setEmployeeId($employee_id)
    {
        ...
        if ((mb_strlen($employee_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AttendanceTransactionListItem., must be smaller than or equal to 15.');
        }
        if ((mb_strlen($employee_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $employee_id when calling AttendanceTransactionListItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCauseCode($cause_code)
    {
        ...
        if ((mb_strlen($cause_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $cause_code when calling AttendanceTransactionListItem., must be smaller than or equal to 3.');
        }
        if ((mb_strlen($cause_code) < 3)) {
            throw new \InvalidArgumentException('invalid length for $cause_code when calling AttendanceTransactionListItem., must be bigger than or equal to 3.');
        }
