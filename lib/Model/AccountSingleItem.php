 ...
 */
class AccountSingleItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountSingleItem';
    ...
    protected static $openAPIFormats = [
        ...
        'year' => 'int32',
        'vat_code' => null,
        'balance_carried_forward' => 'double',
        'transaction_information' => null,
        'transaction_information_settings' => null,
        'quantity_settings' => null,
        'quantity_unit' => null,
        'opening_quantities' => null
    ];
    ...
    protected static array $openAPINullables = [
		...
		'year' => false,
		'vat_code' => false,
		'balance_carried_forward' => false,
		'transaction_information' => false,
		'transaction_information_settings' => false,
		'quantity_settings' => false,
		'quantity_unit' => false,
		'opening_quantities' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'transaction_information_settings' => 'TransactionInformationSettings',
        'quantity_settings' => 'QuantitySettings',
        'quantity_unit' => 'QuantityUnit',
        'opening_quantities' => 'OpeningQuantities'
    ];
    ...
    protected static $setters = [
        ...
        'year' => 'setYear',
        'vat_code' => 'setVatCode',
        'balance_carried_forward' => 'setBalanceCarriedForward',
        'transaction_information' => 'setTransactionInformation',
        'transaction_information_settings' => 'setTransactionInformationSettings',
        'quantity_settings' => 'setQuantitySettings',
        'quantity_unit' => 'setQuantityUnit',
        'opening_quantities' => 'setOpeningQuantities'
    ];
    ...
    protected static $getters = [
        ...
        'year' => 'getYear',
        'vat_code' => 'getVatCode',
        'balance_carried_forward' => 'getBalanceCarriedForward',
        'transaction_information' => 'getTransactionInformation',
        'transaction_information_settings' => 'getTransactionInformationSettings',
        'quantity_settings' => 'getQuantitySettings',
        'quantity_unit' => 'getQuantityUnit',
        'opening_quantities' => 'getOpeningQuantities'
    ];
    ...
    public const TRANSACTION_INFORMATION_SETTINGS_ALLOWED = 'ALLOWED';
    public const TRANSACTION_INFORMATION_SETTINGS_MANDATORY = 'MANDATORY';
    public const TRANSACTION_INFORMATION_SETTINGS_NOTALLOWED = 'NOTALLOWED';
    public const QUANTITY_SETTINGS_ALLOWED = 'ALLOWED';
    public const QUANTITY_SETTINGS_MANDATORY = 'MANDATORY';
    public const QUANTITY_SETTINGS_NOTALLOWED = 'NOTALLOWED';
     ...
     * @return string[]
     */
    public function getTransactionInformationSettingsAllowableValues()
    {
        return [
            self::TRANSACTION_INFORMATION_SETTINGS_ALLOWED,
            self::TRANSACTION_INFORMATION_SETTINGS_MANDATORY,
            self::TRANSACTION_INFORMATION_SETTINGS_NOTALLOWED,
        ];
    }
     ...
     * @return string[]
     */
    public function getQuantitySettingsAllowableValues()
    {
        return [
            self::QUANTITY_SETTINGS_ALLOWED,
            self::QUANTITY_SETTINGS_MANDATORY,
            self::QUANTITY_SETTINGS_NOTALLOWED,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('balance_carried_forward', $data ?? [], null);
        $this->setIfExists('transaction_information', $data ?? [], null);
        $this->setIfExists('transaction_information_settings', $data ?? [], null);
        $this->setIfExists('quantity_settings', $data ?? [], null);
        $this->setIfExists('quantity_unit', $data ?? [], null);
        $this->setIfExists('opening_quantities', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getTransactionInformationSettingsAllowableValues();
        if (!is_null($this->container['transaction_information_settings']) && !in_array($this->container['transaction_information_settings'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'transaction_information_settings', must be one of '%s'",
                $this->container['transaction_information_settings'],
                implode("', '", $allowedValues)
            );
        }

        $allowedValues = $this->getQuantitySettingsAllowableValues();
        if (!is_null($this->container['quantity_settings']) && !in_array($this->container['quantity_settings'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'quantity_settings', must be one of '%s'",
                $this->container['quantity_settings'],
                implode("', '", $allowedValues)
            );
        }
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AccountSingleItem., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling AccountSingleItem., must be bigger than or equal to 1.');
        }
    ...
    public function setNumber($number)
    {
        ...
        if (($number > 9999)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountSingleItem., must be smaller than or equal to 9999.');
        }
        if (($number < 1000)) {
            throw new \InvalidArgumentException('invalid value for $number when calling AccountSingleItem., must be bigger than or equal to 1000.');
        }
    ...
    /**
     * Gets balance_carried_forward
     *
     * @return float|null
     */
    public function getBalanceCarriedForward()
    {
        return $this->container['balance_carried_forward'];
    }

    /**
     * Sets balance_carried_forward
     *
     * @param float|null $balance_carried_forward balance_carried_forward
     *
     * @return self
     */
    public function setBalanceCarriedForward($balance_carried_forward)
    {
        if (is_null($balance_carried_forward)) {
            throw new \InvalidArgumentException('non-nullable balance_carried_forward cannot be null');
        }
        $this->container['balance_carried_forward'] = $balance_carried_forward;
    ...
    /**
     * Gets transaction_information_settings
     *
     * @return string|null
     */
    public function getTransactionInformationSettings()
    {
        return $this->container['transaction_information_settings'];
    }

    /**
     * Sets transaction_information_settings
     *
     * @param string|null $transaction_information_settings transaction_information_settings
     *
     * @return self
     */
    public function setTransactionInformationSettings($transaction_information_settings)
    {
        if (is_null($transaction_information_settings)) {
            throw new \InvalidArgumentException('non-nullable transaction_information_settings cannot be null');
        }
        $allowedValues = $this->getTransactionInformationSettingsAllowableValues();
        if (!in_array($transaction_information_settings, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'transaction_information_settings', must be one of '%s'",
        ...
        $this->container['transaction_information_settings'] = $transaction_information_settings;

        return $this;
    }

    /**
     * Gets quantity_settings
     *
     * @return string|null
     */
    public function getQuantitySettings()
    {
        return $this->container['quantity_settings'];
    }

    /**
     * Sets quantity_settings
     *
     * @param string|null $quantity_settings quantity_settings
     *
     * @return self
     */
    public function setQuantitySettings($quantity_settings)
    {
        if (is_null($quantity_settings)) {
            throw new \InvalidArgumentException('non-nullable quantity_settings cannot be null');
        }
        $allowedValues = $this->getQuantitySettingsAllowableValues();
        if (!in_array($quantity_settings, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value '%s' for 'quantity_settings', must be one of '%s'",
                    $quantity_settings,
        ...
        $this->container['quantity_settings'] = $quantity_settings;
     ...
     * Sets quantity_unit
     *
     * @param string|null $quantity_unit quantity_unit
     *
     * @return self
     */
    ...
    {
        return $this->container['opening_quantities'];
    }
     ...
     * @return self
     */
    public function setOpeningQuantities($opening_quantities)
    {
        if (is_null($opening_quantities)) {
            throw new \InvalidArgumentException('non-nullable opening_quantities cannot be null');
        }
        $this->container['opening_quantities'] = $opening_quantities;
